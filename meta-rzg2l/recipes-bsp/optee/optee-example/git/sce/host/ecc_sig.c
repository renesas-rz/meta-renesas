...
#define SIG_BUFFER_SIZE     (128)
#define KEY_BUFFER_SIZE     (1024)
#define DAT_BUFFER_SIZE     (512)

#define ECC_GEN_MODE        (1)
#define ECC_VER_MODE        (0)
...
static struct ecc_info rsa_list[] = {
    {"nistp192_gen",  PTA_CMD_ECDSA_secp192r1_SignatureGenerate,       ECC_GEN_MODE},
    {"nistp192_ver",  PTA_CMD_ECDSA_secp192r1_SignatureVerify,         ECC_VER_MODE},
    {"nistp224_gen",  PTA_CMD_ECDSA_secp224r1_SignatureGenerate,       ECC_GEN_MODE},
    {"nistp224_ver",  PTA_CMD_ECDSA_secp224r1_SignatureVerify,         ECC_VER_MODE},
    {"nistp256_gen",  PTA_CMD_ECDSA_secp256r1_SignatureGenerate,       ECC_GEN_MODE},
    {"nistp256_ver",  PTA_CMD_ECDSA_secp256r1_SignatureVerify,         ECC_VER_MODE},
    {"bsip512r1_gen", PTA_CMD_ECDSA_BrainpoolP512r1_SignatureGenerate, ECC_GEN_MODE},
    {"bsip512r1_ver", PTA_CMD_ECDSA_BrainpoolP512r1_SignatureVerify,   ECC_VER_MODE},
    {}
};
...
{
    fprintf(stderr, "ECDSA Signature Generation\n");
    fprintf(stderr, "Usage: %s -e [-t <ALGO>] <KEY> <MESSAGE> <SIGNATURE> \n", program);
    ...
    fprintf(stderr, "\t<KEY>            Specify the file name of the wrapped ECC private key. \n");
    ...
    fprintf(stderr, "\t<KEY>            Specify the file name of the wrapped ECC public key. \n");
    fprintf(stderr, "\t<MESSAGE>        Specify the file name of the message to input. \n");
...
{
    int opt;
    char *rsa_opt = "nistp192_gen";
    struct ecc_info *info = NULL;
...
{
    TEEC_UUID uuid = PTA_SCE_ECC_UUID;
    uint32_t origin;
    TEEC_Result res;
...
int ecc_sig_main(int argc, char *argv[])
{
    ...
    printf("Load the wrapped ecc key \"%s\"\n", ctx.wuk_file);
