...
do_poststash_install_cleanup_append() {
        ...
        if [ -d ${D}${datadir} ]; then rmdir --ignore-fail-on-non-empty ${D}${datadir}; fi
}
...
do_install_armmultilib () {
        ...
        oe_multilib_header bits/shm.h bits/sigstack.h bits/stat.h bits/statfs.h bits/typesizes.h bits/floatn.h
