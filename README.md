...
This is a Yocto build layer(version:dunfell) that provides support for the RZ/V2M of 64bit Arm-based MPUs from Renesas Electronics.
Currently the following boards and MPUs are supported:

- Board: RZ/V2M Evaluation Board Kit / MPU: R9A09G011GBG (RZ/V2M)
